...
const day = async (req, res) => {
  ...
  global.db.models.User.find({ wakatimeId: { $ne: null }, _id: body.userId }, async (err, docs) => {
    ...
    const wakatimeRes = await wakatime.get(`/api/v1/users/current/orgs/fabdc280-4d17-4f63-97af-39cbd64cf602/dashboards/6f4a75d8-0fae-42be-816d-d564a5981f4c/members/${doc.wakatimeId}/durations?date=${today}`);
